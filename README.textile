...
class TaskTest < ActiveSupport::TestCase
  should_protect_the_innocent :name=>:name, :email=>:email, :age=>:number, :description=>:test
end
</pre>
...
There is a test helper available if you use shoulda.  The example is at the top
of this page.  It takes the same parameters as your call to protects_the_innocent
in the model itself.
